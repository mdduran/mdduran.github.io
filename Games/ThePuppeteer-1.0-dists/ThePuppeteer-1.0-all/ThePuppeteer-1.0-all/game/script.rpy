...
# The game starts here.
    ...
    label choice0_old:
        ...
        "Bryant’s kept his head down all his life; He stays out of fights, keeps an average amount of friends, watches all the popular shows, eats only typical food."
        ...
        "And he aims to stay at the top. Well, not the very top: he can’t get too good at something."
        scene bg bookstore2
        show bryant normal at left
        show eve normal at offscreenright 
        "And here, as an average retailer in an average bookstore, Bryant Day wi-"
        ...
        "She’s a bit too smart for Bryant’s tastes, but not everyone can be as average as himself."
        ...
        show magicianred norma behind bryant:
            xalign .9 yalign .7
        ...
        m2 "Trying to give me a gimmick along with just magic wands and those barely enchanted playing cards. Why I had better tools when I was just a wee lad playing with dolls!"
        m3 "Next time, we will NOT be buying everything in their shop, let me tell you."
        ...
        m2 "And they’re quite good conversationalists as well, I would know."
        ...
        m "And you suggest there’s nothing to write about their wonderful and completely existent thought process?"
        m2 "Are you mad?"
        ...
        e "Sure thing, sir."
        show magicianred casting at offscreenright with move
        show magicianblue casting at offscreenright with move
        show magicianyellow casting at offscreenright with move
        show magiciangreen casting at offscreenright with move
        play music "main.ogg"
    ...
    #Marco: edited more errors on 10/6/2013 4:44 pm
        ...
        label choice1_sleep:
            ...
            scene bg apartmentday 
            show bryant angry
            e "Oh crap, now I’m late! I shouldn’t have wasted so much time in bed!"
            jump choice1_done
        label choice1_work:
            jump choice1_done
            label choice1_done:
        ...
        label choice2_getajob:
            ...
            show hobo angry at right
            h "You’re more dirty than me, you ungrateful little shit! *grumble grumble*"
        ...
        label choice4_insult:
                $ weirdness += 2
                e "Under the big sign that says history, dumbass."
                c "Well, I never!"
                show bryant normal at left with move
...
#Marco: fixed grammatical errors up to here on 10/6/2013
        label choice5_vbad:
                ...
                "..."
                show eve angry at left
                l "What the hell, Bryant!? I’m the one who recommended you to the manager in the first place, and now you’re suddenly an ungrateful bastard who can’t deign to carry a few books between customers?"
                l "Fine then, fuck you. Asshole."
                e "What the hell!? Eve is my best friend, why did I insult her like that?"
                jump choice5_done
        label choice5_done:
            if (weirdness <= 0):
                ...
                e "First thing tomorrow, I’ll go to the library and ask her about it."
                scene black
                "Tap to continue ..."
                play sound "spell.ogg"
            elif (weirdness >= 4):
                ...
                e "It’s like I just got these random impulses to do irregular things, and I did them without thinking about it till afterwards."
                e "This is freaky. And dangerous. I feel like I don’t have control over what I’m doing anymore."
                e "Wait! Those magician weirdoes yesterday, didn’t they cast some sort of puppet spell on me yesterday?"
                e "I’d never believe in unaverage junk like that working in a million years, but could my random arse actions today possibly be proof? I’ve got to be sure!"
                e "I have the rest of the week off..."
                e "I know Eve saw them, maybe she saw what they were doing when they were pretending to cast a spell on me, or what they were babbling about with the dolls or whatever."
                e "I’ve got to ask her about it tomorrow. For now, I’ve got to rest my mind from all this disgusting unaverageness."
                scene black
                "Tap to continue ..."
                play sound "spell.ogg"
                #scene bg nightclub
               # show bryant animated
            ...
            show bryant normal at right
            show eve normal at left
            e "Eve! You got a minute?"
            if (evepissed == 1):
                l "Not even a second for an asshole like you."
            elif (evepissed == 0):
                l "Trying to hit on me, are you? Finally realize how much you need me?"
            e "Don‘t be a bitch, Eve."
            e "You know those magician guys that I was talking to yesterday?"
            l "Yeah, I’ve read about their cult before. The whole book on them is in the history section."
            e "Did you read anything about their curses?"
            l "Yeah, they can cast a spell on nonbelievers that causes their actions to be controlled by another cult member somewhere else."
            l "The spell was easy to cast but costs a lot of energy to maintain, so they ensured the host would die soon by causing them to die on the eve of the full moon."
            e "How does one undo the curse?"
            l "By collecting the symbols of power from the ones who originally casted the spell. Then just holding them during the full moon, and then the spell wears off."
            e "Thanks for having all that information conveniently on hand and memorized."
            l "No prob broski. Go be average or something."
            l "Also, try to be average at the police station, just a tip."
            
            scene bg citysidewalk
            show bryant normal at right
            show hobo normal at left with dissolve
            e "Oh, you again."
            h "I am the hobo warlord now, I demand tribute."
            menu:
                "Give him some money.":
                    jump choice6_money
                "Ignore him.":
                    jump choice6_ignore
            label choice6_money:
                e "Fine, here’s some money then."
                show hobo happy at left
                h "Lord hobo is appeased. Continue on your quest, young man."
                jump choice6_done
            label choice6_ignore:
                e "No way!"
                show hobo angry at left
                h "Guards, arrest this man!"
                "Right away, Lord Hobo."
                e "Wait, what? Arrested for ignoring a hobo?"
                "That’s “Lord Hobo”, peasant. And he was declared mayor for the week after winning a town hall raffle."
                "Refusing Lord Hobo incurs a one night’s stand in the slammer, no bail."
                e "Well, damn."
                jump choice6_done
            label choice6_done:
    ...
    #Marco: 10/7/2013 11:38 pm edited some more grammar.
                                g "This here magician is the leader of our club here, yo. You should buzz off before we cap ya one."
                                e "Can I have your hat?"
                                m3 "Only if you can dodge a stream of bullets."
                                show gangster animated at center
                                play music "gunshot.wav"
                                menu:
                                    "Dodge a stream of bullets.":
                                        jump choice7_dodge
                                    "Get hit by a stream of bullets.":
                                        jump choice7_die
                                label choice7_dodge:
                                    e "Oh..."
                                    e "Well..."
                                    ...
                                    jump map
                                label choice7_die:
                                    e "Aw shit man, I got shot like a dozen times. Laaame"
                                    ...
                                    label pschoice:
                                        ...
                                        label choice8_turnin:
                                            ...
                                            label choice9_takeitback:
                                                ...
                                                p "Please don’t joke like that, sir. Sometime we actually do get the occasional guilty fellow that warrants attention."
                                            ...
                                            label choice9_sexy:
                                                ...
                                                p "Excuse me?"
                                                e "It should be illegal to look as good as I am. My guilty conscious can no longer tolerate how unfairly distracting I am to the opposite sex."
                                                show policeman angry at left
                                                p "Sir, stop, please."
                                            ...
                                            label choice9_murder:
                                                ...
                                                p "Who?"
                                                e "Uhhh, ummm, That hobo whose been begging for money daily now. I beat him within an inch of his life."
                                                ...
                                                e "Wait, what? You’re an officer?"
                                                p "Yeah, yeah. Just saying you’re in good company."
                                                p "(Just between you and me, us here at the force wouldn’t look to deeply into it if he went missing, if you know what I mean?)"
                                                e "You can’t be serious."
                                                p "Just putting it out there. Anything else on your mind?"
                                                jump pschoice
                                            label choice9_littering:
                                                ...
                                                label choice10_pay:
                                                    if (money > 0):
                                                        ...
                                                        p "Excuse me, sir?"
                                                        e "You heard me, thief. 100$ for littering? Disgusting how our country tolerates such a corrupt system of organized extortion."
                                                        p "Sir, you just-"
                                                        p "..."
                                                        p "Nevermind, (geez, some people)"
                                                        e "What was that?"
                                                        p "Nothing, sir. Now what that’s all sorted out, anything else you need here?"
                                                        jump pschoice
                                                    else:
                                                        e "I’ll pay the fi-"
                                                        e "Oh wait, I don’t have any money on me."
                                                ...
                                                label choice10_nopay:
                                                    ...
                                                    p "*Hours later, in jail cell*"
                                                    p "You’re free to go."
                                                    e "WHAT? It hasn’t been a full day yet. I haven’t learned my lesson."
                                                    p "Uh, we’re setting you out early for good behavior."
                                                    ...
                                                    e "NO. PUNISH ME."
                                                    p "Sir, get out."
                                                    e "Such a weak system, soft on crime, should bring back the death penalty, grumble grumble."
                                                ...
                                                label choice10_bribe:
                                                    if (money > 200):
                                                        ...
                                                        e "Wow, what a smart guy. You see right through me, a real cop. Tell ya what, I’ll throw in another hundred, whatdayasay?"
                                                        p "Sir ..."
                                                        p "..."
                                                        p "Uh, ok then, I guess 200 will do it."
                                                        e "Here you are, officer. Smart man. This will blow over quick, don’t you worry. I’ll keep my head down from now on, move outa town."
                                                        ...
                                                        e "Noones gonna know, offica. I ain’t a rat."
                                                        p "No way. Forget it. Just keep your money and go away."
                                                        e "That works too, I guess."
                                                        p " Then, uh, anything else?"
                                                        jump pschoice
                                        label choice8_ask:
                                            e "I’m looking for a bunch of weirdo’s in silly hats. Have you heard of anyone like that?"
                                            if choice8b:
                                                ...
                                                scene bg jail
                                                show magiciangreen casting at right
                                                show bryant normal at left
                                                m4 "-and my sundial doesn’t even work in here! How am I suppose to tell when second breakfast is occurring? Simply outrageous!"
                                                m4 " Oh, its you. Have you come to deliver the requested tomes?"
                                                e "You remember me?"
                                                m4 "Of course. An elephant never forgets, and me, a magician, being at least equal to an elephant in every way, do so as well. "
                                                e "Rather, don’t do"
                                                e "considering how I was discussion how I do NOT forget things. As well as or better than an elephant."
                                                m4 "Wait, what were you here for again?"
                                                label jailchoice:
                                                    menu:
                                                        "Leave":
                                                            e "Nothing, really. See you, then."
                                                            m4 "Oh. Bye. Be sure to get those books soon, you can never stock enough on puppet psychology."
                                                            scene bg policestation
                                                            show bryant normal at right
                                                            show policeman normal at left
                                                            p "Done discussing with him, then?"
                                                            e "Yep."
                                                            p "Alrighty. Need anything else while you’re here?"
                                                            jump pschoice
                                                    ...
                                                    label choice11_how:
                                                        ...
                                                        m4 "Eh? All powerful doesn’t mean all abusing. They we’re coming at me with pitiful little guns, It was almost laughable."
                                                    ...
                                                    label choice11_punch:
                                                        ...
                                                        show bryant normal at left
                                                        m4 "OW! Owww..."
                                                        e "Whose the all powerful magician now, asshole?"
                                                        m4 "Urg, still me of course, I’m just counter casting your physical damage with, uh, a holy mantra.  Puppet mantra, yeah. "
                                                        e "OwwwwOWWWowwwowwwwwwooothatstingsowwwwwww…"
                                                        ...
                                                        p "The law says otherwise. We’ll let you go before sunset, if you can keep your fists to yourself."
                                                    ...
                                                    label choice11_curse:
                                                        if (knowledge == 0):
                                                            ...
                                                            m4 "Well, now you know how a puppet feels when some newbie jerks him around by the strings till he breaks. Sucks, don’t it?"
                                                            e "Well, undo it!"
                                                            m4 "Nope. Not till you learn to show puppets a little more respect for what they’ve been through. It’ll wear off on its own anyways, quit being a baby about it."
                                                            jump jailchoice
                                                        else:
                                                            ...
                                                            m4 "White knight pricks didn’t like spells that enslaved the general populace, so they jinxed all the good curses to make it so they got the control instead of us."
                                                            m4 "So we just started mass enslaving people till they were so overflowed with orders that they just stopped caring how good they were being."
                                                            m4 "Still a loss, since we can’t have human puppets anymore, but at least we annoyed them."
                                                            e "So how is this suppose to show me how it feels to be a puppet?"
                                                            m4 "Oh. Uhhh... "
                                                            m4 "we’ll you’re still under someone elses control arn’t you?  Sucks, don’t it?"
                                                            e "Yeah, I guess."
                                                            m4 "We’ll thats how a puppet feels, like every day. Tough it out, wimp. Show some respect."
                                                            jump jailchoice
                                                    label choice11_hat:
                                                        m4 "Eh? Why?"
                                                        if (knowledge < 2):
                                                            ...
                                                            e "Cmon, you already have a mask, how much headwear do you need? You’ll still look plenty weird without it, dont worry."
                                                            ...
                                                            m4 "Well, its just a minor side effect. Barely worth mentioning in most cases."
                                                            e "What?!?"
                                                            m4 "Uh, not in this case, I suppose. At least on your end."
                                                            e "So cmon, hand over the hat."
                                                            m4 "Wait, I can’t just “hand over the hat” for a minor mistake, cmon now,"
                                                            m4 "Its my pride and joy. I’ve been wearing it since my first act of puppeteering. I had my first puppet put it on my head for me! Oh, the memories…"
                                                            e "I’m going to die if I don’t have it! Or can you undo the curse somehow?"
                                                            m4 "I can’t undo it at this point, but I can’t just give the hat away for free"
                                                            ...
                                                            e "You’re wizarding culture? You curse people for the most minor slights and apparently value your hat more than my life."
                                                            ...
                                                            label choice12_leave:
                                                                ...
                                                                m4 "Eh? Aren’t you going to die without my hat? Its just a simple quiz?"
                                                            ...
                                                            label choice12_alchemists:
                                                                ...
                                                                e "Speaking of which, I still need your friend’s hats. Do you know where they are?"
                                                                ...
                                                                m4 "Anyways, he’ll probably want you to prove yourself to him too, so just explain things to him and prepare to do another quiz or something."
                                                                ...
                                                                m4 "Meanwhile, I suppose I can tolerate serving as your new ruler for a while, at least till I grow so bored."
                                                                e "Right, you do that."
                                                                jump map
                                                            label choice12_witches:
                                                                ...
                                                                m4 "Oh hell no, we’ve had and will have nothing to do with those disgusting mockeries. You’re trying to mock me, arnt you?"
                                                            ...
                                                            label choice12_punch:
                                                                ...
                                                                show bryant normal at left
                                                                m4 "OW! Owww..."
                                                                e "Whose the all powerful magician now, asshole? Now hand over the hat already!"
                                        ...
                                        label choice8_report:
                                            ...
                                            p "Just don’t joke around like that. Do you really need something here, though?"
                                            jump pschoice
                            return
                                ...
                                if result == "bookstore":
                                    ...
                                    label bankchoice2:
                                        ...
                                        label choice23_rob2:
                                            ...
                                            p "Release the hostages and lay down your weapons, NOW."
                                            ...
                                            label choice25_hostage2:
                                                p "PROVE IT."
                                                "NO, PLEASE, I HAVE A WIFE AND KIDS. MERCY"
                                                bt "HES IGNORING THE HOSTAGE AFTER BEING ASKED SO POLITELY. TAKE HIM DOWN."
                                                play music "gunshot.wav"
                                                show policeman shooting at right
                                                pause
                                                scene bg death
                                                                                            ...
                                                                                            "Just roll with it for the corny ending, already ":
                                                                                                ...
                                                                                                label cryptlast2:
                                                                                                        ...
                                                                                                        if (hobo < 3):
                                                                                                            ...
                                                                                                            h "Piss off then, you arrogant little shit! *mumble mumble*"
                                                                                                        else:
                                                                                                            e "Hmmm, I don’t think I’m in trouble with the law anymore…"
                                                                                                            e "..."
                                    ...
                                    e "(the hobo)"
                                    if (hobo == 0):
                                        h "Ay, you! Yeah, you! Gimmy some cash, you’re just gonna waste it."
                                    else:
                                    ...
                                    label swalkchoice2:
                                        ...
                                        label choice22_ask2:
                                            if (hobo == 0):
                                                e "How’d you end up here anyways? And don’t you ever go anywhere else? To eat or something?"
                                                ...
                                                e "Cmon, anything about yourself?"
                                                ...
                                                h "Uh, ah, ehhh..."
                                                e "What, where your parents overly flamboyant and arrogant about rich, giving you a complex against those with high social status and causing you to alienate yourself from them in an act of defiance and run away to become a homeless vagabond?"
                                        ...
                                        label choice22_give2:
                                            ...
                                            if (money == 0):
                                                ...
                                                h "Oh, riiight, I get that all the time, asshole. All you snobs and your fancy coats and your fancy hats with your “Oh, I don’t have any spare for a starving man”"
                                                h "Well then why don’t I see you sittin down here with me then? Huh?"
                                                ...
                                                e "You know, its entirely possible for you to work for that money yourself?"
                                        ...
                                        label choice22_punch2:
                                            ...
                                            p "I’ve been here the whole time. City’s got a special division posted just for defending this hobo."
                                            ...
                                            p "If we lose him, its like we’re losing part of the qualification."
                                            h "You tell him, officer! Beat the shit outa him!"
                                            ...
                                            p "FOR FUCKS SAKE, SHUT UP."
                                            h "..."
                                            p "..."
                                            p "Geezus, I gotta hear you beg all day, but I ain’t tolerating that shit."
                                            e "…so my punishment?"
                                            p "… Well, I guess I can’t really blame you for wanting to beat the shit outa him, How’s about I just hold you at the station for a while and let you go before sunset?"
                                            e "Fine with me."
                                        ...
                                        label choice22_job2:
                                            ...
                                            h "Think they’re too good for me, well I’m too good for them, they just don’t know it, I’ll have you know"
                                            ...
                                            h "Fucks your problem boy? Don’t butt in on other people’s business, look at you, mocking a poor beggar."
                                            e "But you were just asking me for money a second ago?"
                                            h "Now what, you’re bragging about it?"
                                            h "Probably some rich snot with nothing better to do than annoy me, rather than helping me with some cash, eh, arn’t you? Feels good, rich boy? Having fun?"
                                    ...
                                    jump map2
                                            ...
                                            label nightclub_22:
                                                ...
                                                g2 "Yeah man, Don’t dey burn your brain and shit? Unhealthy shit, man."
                                            ...
                                            label nightclub_32:
                                                ...
                                                g2 "You sayin we should sit tight while our family’s at deaths door bro? You sayin you wouldn’t man up and do whatever you needed to do for yo family? Huh?"

                                                e "Oh, geez, I didn’t know. Sorry."

                                                g2 "Ha, we just messin with you. All for the cash."

                                                g "Yeah, all for the cash, brutha. Rakin in the dough, make it rain, hollaatcha, ya know?"

                                                "…"

                                                g2 "Ha, spud don’t know. Little puss if I ever saw one, and I saw plenty, let me tell ya."
                                            ...
                                            label nightclub_42:
                                                ...
                                                if(hat < 2):
                                                    ...
                                                    g2 "Ol Capone came back, but he ain’t feelin so hot after the full fiasco, you know what I’m sayin?"
                                                ...
                                                label nightclub_4_22:
                                                        ...
                                                        mb "Well, you do look pretty average… No one would suspect a guy like you of being a stone cold killer."
                                                        ...
                                                        mb "Tell ya what: you prove yourself with an easy hit, and I’ll forgive your cheek: whack that annoying ass hobo I keep seein pandering on the streets."

                                                        e "Eh? You mean that ungrateful sob who treats you like shit if you don’t give over everything you got?"

                                                        mb "Yeah, that’s the one. Make it clean, too; get him gone, and don’t leave a trace. Coulda just walked outa town, cops wouldn’t know any better."
                                            ...
                                            label nightclub_52:
                                                    ...
                                                    m2 "I see, see? Think you can just wipe out all us magicians and get away with it, eh, see?"
                                                    ...
                                                    g2 "Woa, he’s showin more mojo than you do!"

                                                    m2 "…Just a fluke, see? I was goin easy on him, see?"

                                                    g2 "Eh, boss, we were the ones shootin-"

                                                    m2 "Well shoot again, see?!? Keep doin it till you run out of ammo, see!?!"
                                    ...
                                    label pschoice2:
                                        ...
                                        label choice8_turnin2:
                                            ...
                                            label choice9_murder2:
                                                ...
                                                p "Just between you and I, everyone here at the force wouldn’t look too deeply into it if he went missing, if you know what I mean..."
                                                e "You can’t be serious..."
                                            ...
                                            label choice9_littering2:
                                                ...
                                                label choice10_pay2:
                                                    if (money > 0):
                                                        ...
                                                        p "Nevermind..."
                                                        e "What was that?"
                                                        p "Nothing, sir. Now what that’s all sorted out, is there anything else you need?"
                                                        jump pschoice2
                                                    else:
                                                        e "I’ll pay the fi-"
                                                        e "Oh wait, I don’t have any money on me."
                                                ...
                                                label choice10_bribe2:
                                                    if (money > 200):
                                                        ...
                                                        p "..."
                                                        p "Sir, are you trying to bribe me?"
                                                        e "Wow, what a smart guy. You see right through me, a real cop. Tell ya what, I’ll throw in another hundred, what do you think?"
                                                        p "Sir..."
                                                        p "..."
                                                        p "Uh, ok then, I guess $200 will do it."
                                                        e "Here you are, officer. Smart man. This will blow over quick, don’t you worry. I’ll keep my head down from now on, move outa town."
                                                ...
                                                label jailchoice2:
                                                    menu:
                                                        "Leave":
                                                            ...
                                                            show bryant normal at right
                                                            show policeman normal at left
                                                            p "Are you done discussing with him, then?"
                                                            e "Yep."
